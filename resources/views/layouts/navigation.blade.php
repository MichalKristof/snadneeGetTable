    ...
    <div class="max-w-7xl mx-auto h-20 px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-full items-center">
            <div class="flex items-center justify-center">
                ...
                @auth
                    <div class="hidden space-x-4 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('reservation.reservations')"
                                    :active="request()->routeIs('reservation.reservations')">
                            {{ __('My reservations') }}
                        </x-nav-link>
                    </div>
                @endauth
            ...
            <div class="hidden space-x-4 sm:-my-px sm:ml-10 sm:flex">
                @auth
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="flex items-center text-white text-sm font-medium hover:text-gray-300 focus:outline-none focus:text-gray-300 transition duration-150 ease-in-out">
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="open = !open"
                        class="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-gray-300 focus:outline-none focus:text-gray-300 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': !open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-700">
            ...
            <div class="mt-3 space-y-1">
                @auth
                    <x-responsive-nav-link :href="route('reservation.reservations')">
                        {{ __('Reservations') }}
                    </x-responsive-nav-link>
